...
import static com.example.myevents.TrainingActivity.TRAINING_KEY;
...
public class PlanAdapter extends RecyclerView.Adapter<PlanAdapter.ViewHolder> {
    ...
    public interface AccomplishedPlan{
        void onAccPlanResult(Plan plan);
    }

    private RemovePlan removePlan;
    private AccomplishedPlan accomplishedPlan;
                            ...
                            .setNegativeButton("No", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        ...
                                        accomplishedPlan = (AccomplishedPlan) context;
                                        accomplishedPlan.onAccPlanResult(plans.get(position));
                                    }
