...
public class EditActivity extends AppCompatActivity implements PlanAdapter.RemovePlan, PlanAdapter.AccomplishedPlan {
    ...
    @Override
    public void onAccPlanResult(Plan plan) {
        if (Utils.getInstance(this).accomplishedPlan(plan));
